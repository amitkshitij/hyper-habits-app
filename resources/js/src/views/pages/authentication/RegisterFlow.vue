...
<b-button class=""
  ...
  <div class="auth-wrapper auth-v1 rg-flow ">
    <div class="auth-inner py-2 text-center match-height">
            <!-- Register v1 -->
      <b-card class="mb-0">
        <h2>Welcome</h2>
          <b-img
        ...
        <!-- social buttons -->
         <b-card-text>
            <h3>Take a Challenge. <br> Be the Change.</h3>
